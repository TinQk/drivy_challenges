...
# Return a hash with the commission's détail of a rental
def commission(rental)
  ...
  hash = {"insurance_fee": insurance_fee, "assistance_fee": assistance_fee, "drivy_fee": drivy_fee}
end
...
@rentals.each do |rental|
  hash = {"id": rental["id"], "price": price(rental), "commission": commission(rental)}
  rentals_output << hash
end
